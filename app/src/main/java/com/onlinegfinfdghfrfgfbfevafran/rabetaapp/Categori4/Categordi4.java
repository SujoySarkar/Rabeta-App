...
import com.onlinegfinfdghfrfgfbfevafran.rabetaapp.Categori_3.Modelcat;
import com.onlinegfinfdghfrfgfbfevafran.rabetaapp.Categori_3.Viewholdercat;
import com.onlinegfinfdghfrfgfbfevafran.rabetaapp.R;

public class Categordi4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Cat4");
        setContentView(R.layout.activity_categordi4);
        ...
        mRef = mFirebaseDatabase.getReference("four");
    ...
    public boolean isOnline() {
        ...
        if(netInfo == null || !netInfo.isConnected() || !netInfo.isAvailable()){
            Toast.makeText(Categordi4.this, "Turn on Internet connection!", Toast.LENGTH_LONG).show();
            return false;
        }
        return true;
    }
    ...
    protected void onStart() {
        super.onStart();
        FirebaseRecyclerAdapter<Modelcat, Viewholderfour> firebaseRecyclerAdapter =
                new FirebaseRecyclerAdapter<Modelcat, Viewholderfour>(
                        Modelcat.class,
                        R.layout.samplefour,
                        Viewholderfour.class,
                        mRef
                ) {
                    @Override
                    protected void populateViewHolder(Viewholderfour viewHolder, Modelcat model, int position) {
                    ...
                    @Override
                    public Viewholderfour onCreateViewHolder(ViewGroup parent, int viewType) {



                        Viewholderfour viewHolder = super.onCreateViewHolder(parent, viewType);
                        ...
                        viewHolder.setOnClickListener(new ViewHolder.ClickListener() {
                            ...
                            public void onItemClick(View view, int position) {
                                ...
                                Intent intent = new Intent(view.getContext(), Detailsfour.class);
